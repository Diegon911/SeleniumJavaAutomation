...
Scenario Outline: Registro de usuario correcto
  ...
  |Test123|Testing123|01011991        |TestAddress99 |09999        |TestCity|TestState|5555555555|XTestingT12045@test.com|Testing@091|
...
Scenario Outline: Registro de usuario sin apellido
  ...
  Examples:
  |nombre |fecha nacimiento|direccion     |codigo postal|ciudad  |estado   |telefono  |email              |password   |
  |Test123|01011991        |TestAddress99 |09999        |TestCity|TestState|5555555555|Testing020@test.com|Testing@091|
